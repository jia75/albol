...
VIEW-ARTIST.
    ...
    PERFORM UNTIL EOF-REACHED
        READ ALBUM-LIST-FILE
            ...
            NOT AT END IF FUNCTION LOWER-CASE(ALBUM-ARTIST-RECORD) EQUAL 
                ...
                MOVE LENGTH OF FUNCTION TRIM(ALBUM-TITLE-RECORD) TO 
                        STRING-LENGTH
                ...
                MOVE LENGTH OF FUNCTION TRIM(ALBUM-TITLE-RECORD) TO 
                        STRING-LENGTH
                MOVE FUNCTION TRIM(ALBUM-TITLE-RECORD) TO LINE-OUTPUT
    ...
    DISPLAY "AVERAGE RATING OUT OF " RATING-COUNT " RATED RECORDS."
    ...
    PERFORM UNTIL EOF-REACHED
        READ ALBUM-LIST-FILE
            ...
            NOT AT END IF ALBUM-TITLE-RECORD NOT EQUAL " "
                ...
                MOVE LENGTH OF FUNCTION TRIM(ALBUM-ARTIST-RECORD) TO 
                        STRING-LENGTH
                COMPUTE STRING-LENGTH = (50 - STRING-LENGTH) / 2
                MOVE SPACES TO LINE-OUTPUT
                MOVE 1 TO PAD-INDEX
                ...
                MOVE LENGTH OF FUNCTION TRIM(ALBUM-ARTIST-RECORD) TO 
                        STRING-LENGTH
                MOVE FUNCTION TRIM(ALBUM-ARTIST-RECORD) TO LINE-OUTPUT 
                        (PAD-INDEX:STRING-LENGTH)
                DISPLAY LINE-OUTPUT "|"
